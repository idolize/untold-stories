...
/**
 * Class that represents an individual room inside the game server.
...
GameRoom.prototype.attemptJoin = function(socket, username, isCreator) {
...
GameRoom.prototype.leave = function(socket, isCreator) {
  ...
  if (success) { // lobby joined but game not started yet
    ...
    var onGameStarted = function() {
      ...
      socket.on('turnEnded', function(changes) {
        ...
        //changes.turnNumber++;
        changes.isCreator = isCreator;
        // TODO either store the diff as-is, or apply it here and store the result...

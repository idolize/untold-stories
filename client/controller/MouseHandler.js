...
MouseHandler.prototype.startListening = function() {
  ...
  this._mouseDownHandlerBound = this.stage.on('stagemousedown', mouseDownHandler, this);
  this._mouseUpHandlerBound = this.stage.on('stagemouseup', mouseUpHandler, this);
  this._mouseMoveHandlerBound = this.stage.on('stagemousemove', mouseMoveHandler, this);
};

MouseHandler.prototype.stopListening = function() {
  this.stage.enableDOMEvents(false);
  this.isMouseDown = false;
  this.stage.off('stagemousedown', this._mouseDownHandlerBound);
  this.stage.off('stagemouseup', this._mouseUpHandlerBound);
  this.stage.off('stagemousemove', this._mouseMoveHandlerBound);
};

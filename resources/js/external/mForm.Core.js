...
var mForm = new Class({
	...
	options: {
		...
		submitFormOnControlS: false,		// submits your form when pressing [control] + [s] in textareas or input fields
		...
		validateOnBlur: true,			// true will validate elements when they loose focus (onBlur)
